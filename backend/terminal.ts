...
export class Terminal {
    ...
    protected socketList : Record<string, SiloSocket> = {};

    constructor(server : SiloServer, name : string, file : string, args : string | string[], cwd : string) {
        this.server = server;
        this._name = name;
    ...
    public join(socket : SiloSocket) {
        this.socketList[socket.id] = socket;
    }

    public leave(socket : SiloSocket) {
    ...
    public static getOrCreateTerminal(server : SiloServer, name : string, file : string, args : string | string[], cwd : string) : Terminal {
...
export class MainTerminal extends InteractiveTerminal {
    constructor(server : SiloServer, name : string) {
        let shell;
