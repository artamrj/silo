...
import { TERMINAL_COLS, TERMINAL_ROWS } from "../../../shared/utils";
...
export default {
    ...
    mounted() {
        ...
        // Capture native paste events from xterm's hidden textarea. This supports
        // Cmd+V, Ctrl+V, and the browser's Paste command without Clipboard API permission.
